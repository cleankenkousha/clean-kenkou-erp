    ...
    return (
      <div className="w-full space-y-1">
        ...
        <input
          ...
          } rounded-md px-3 py-2.5 min-h-[44px] text-sm text-main placeholder-sub focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-slate-900 transition-all ${className}`}
          {...props}
        />
